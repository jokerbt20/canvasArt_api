...
public interface IFrameRepository
{
    ...
    Task<FrameAggregate?> GetAggregateByIdAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<int> CreateAsync(Frame frame, IReadOnlyList<FrameSize> sizes, CancellationToken cancellationToken = default);
    Task UpdateAsync(Frame frame, IReadOnlyList<FrameSize> sizes, CancellationToken cancellationToken = default);
    ...
    Task<FrameSize?> GetSizeAsync(int frameSizeId, CancellationToken cancellationToken = default);
